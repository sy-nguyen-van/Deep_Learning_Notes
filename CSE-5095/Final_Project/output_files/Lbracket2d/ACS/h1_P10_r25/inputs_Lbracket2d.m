...
OPT.functions.objective = 'maximum stress violation'; % maximum stress violation
...
OPT.functions.constraint_limit = [OPT.vf]; % ***
...
OPT.parameters.slimit = 1;
% Adaptive constraint scaling
OPT.parameters.ACS.use = 0;
